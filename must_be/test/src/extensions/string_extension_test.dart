  ...
  group('String', () {
    ...
    group('url', () {
      test(
          ...
          'then an exception will not be thrown', () {
        String? value;
        expect(() => requireThat(value).mustBeUrl(), returnsNormally);
      });
      ...
      test(
          ...
          'then an exception will not be thrown', () {
        expect(
          () => requireThat('https://google.com').mustBeUrl(),
          returnsNormally,
        );
        expect(
          () => requireThat('http://google.com').mustBeUrl(),
          returnsNormally,
        );
        expect(
          () => requireThat('https://www.instagram.com').mustBeUrl(),
          returnsNormally,
        );
        expect(
          () => requireThat('https://www.instagram.com/').mustBeUrl(),
        ...
        expect(
          () => requireThat('www.instagram.com').mustBeUrl(),
          returnsNormally,
        );
      });

      test(
          'if the value is not a url, '
          'then an exception is thrown', () {
        expect(
          () => requireThat('test').mustBeUrl(),
          throwsConstraintException<Url>(
            constraintMessage: 'Must be a url',
          ),
        );
      });
      ...
      test(
          ...
          'then an exception is thrown - Custom Message', () {
        expect(
          () => requireThat('test').mustBeUrl('url'),
          throwsConstraintException<Url>(constraintMessage: 'url'),
        );
      });
    });
    ...
    group('credit card', () {
      test(
        ...
        String? value;
        expect(
          () => requireThat(value).mustBeCreditCard('value'),
          returnsNormally,
        );
      });

      test(
          'if the String is a valid credit card, '
          'then an exception will not be thrown', () {
        expect(
          () => requireThat('378282246310005').mustBeCreditCard(),
          returnsNormally,
        );
        expect(
          () => requireThat('4111111111111111').mustBeCreditCard(),
          returnsNormally,
        );
      });

      test(
          'if the String is not a valid credit card, '
          'then an exception is thrown', () {
        expect(
          () => requireThat('3782822463100').mustBeCreditCard(),
          throwsConstraintException<CreditCard>(),
        );
        expect(
          () => requireThat('411rf').mustBeCreditCard(),
          throwsConstraintException<CreditCard>(),
        );
      });
      ...
      test(
          ...
          'then an exception is thrown - Custom Message', () {
        expect(
          () => requireThat('43949838493')
              .mustBeCreditCard('not a valid credit card'),
          throwsConstraintException<CreditCard>(
            constraintMessage: 'not a valid credit card',
          ),
        );
      });
    });
